...
CREATE TABLE `alumnos` (
  ...
  `observacion` varchar(300) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'Ciencias Naturales', '2022-02-12 10:16:03', '2022-02-12 10:16:03'),
(2, 'Sociales', '2022-02-12 10:16:10', '2022-02-12 10:16:10');
...
(55, '2022_02_11_221142_create_grados_table', 1),
(56, '2022_02_11_221153_create_materias_table', 1),
(57, '2022_02_11_221215_create_alumnos_table', 1),
(58, '2022_02_11_221242_create_materias_grados_table', 1);
...
ALTER TABLE `alumnos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `alumnos_grado_id_foreign` (`grado_id`);
...
ALTER TABLE `materias_grados`
  ADD PRIMARY KEY (`id`),
  ADD KEY `materias_grados_grado_id_foreign` (`grado_id`),
  ADD KEY `materias_grados_materia_id_foreign` (`materia_id`);
...
--
ALTER TABLE `alumnos`
  ADD CONSTRAINT `alumnos_grado_id_foreign` FOREIGN KEY (`grado_id`) REFERENCES `grados` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `materias_grados`
--
ALTER TABLE `materias_grados`
  ADD CONSTRAINT `materias_grados_grado_id_foreign` FOREIGN KEY (`grado_id`) REFERENCES `grados` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `materias_grados_materia_id_foreign` FOREIGN KEY (`materia_id`) REFERENCES `materias` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
